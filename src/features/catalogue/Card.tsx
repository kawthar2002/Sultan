  ...
  return (
    <div className="catalogue-card">
      <div className="catalogue-card__image">
        <img src={img_url} alt="aos" />
      </div>
      <div className="catalogue-card__info">
        <div className="size">
          {size.unit === 'г' && <Box color="#3F4E65" />}
          {size.unit === 'мл' && <Bottle color="#3F4E65" />}

          <span>{`${size.amount} ${size.unit}`}</span>
        </div>
        <div className="catalogue-card__title">
          <Link to={`/goods/${id}`}>{name}</Link>
        </div>
      ...
      <div className="catalogue-card__order">
        <div className="catalogue-card__price">{`${price.amount} ${price.currency}`}</div>
        <button
