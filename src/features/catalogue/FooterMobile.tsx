  ...
  return (
    <div className="footer-mobile">
      <div className="footer-mobile__top">
        <img src="./img/footer/footer-logo-mobile.svg" alt="Sultan" />
        <button className="button">
          ...
          >
            <path
              d="M8.79199 3.375H6.62532V0.125H3.37532V3.375H1.20866L5.00032 7.70833L8.79199 3.375ZM0.666992 8.79167H9.33366V9.875H0.666992V8.79167Z"
              fill="white"
            />
          </svg>
        </button>
      </div>
      <div className="footer-mobile__text">
        <p>
          Компания «Султан» — снабжаем розничные магазины товарами "под ключ" в
          Кокчетаве и Акмолинской области
        </p>
      </div>
      <form className="footer-subscribe form-mobile" action="submit">
        <span>Подпишись на скидки и акции</span>
        <label className="input footer-input input-mobile">
      ...
      <div className="footer-mobile-lists">
        <ul className="footer-list footer-mobile__list">
      ...
      <div className="footer-contacts footer-mobile-contacts">
